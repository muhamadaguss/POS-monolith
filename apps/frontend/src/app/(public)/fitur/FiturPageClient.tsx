        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/register" className="text-white text-sm font-semibold px-5 py-2 rounded-xl transition-all hover:shadow-lg hover:scale-105" style={{ backgroundColor: COLORS.primary }}>
                Coba Gratis
              </Link>
            </div>
