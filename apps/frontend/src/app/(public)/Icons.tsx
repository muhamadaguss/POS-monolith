// Ultra-light SVG icons for critical path — replaces 4 lucide-react imports (~12KB)
// Lucide still used in lazy-loaded sections and less-frequent icons (ShoppingCart etc.)
