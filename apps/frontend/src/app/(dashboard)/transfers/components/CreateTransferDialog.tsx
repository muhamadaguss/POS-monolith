...
import { createTransfer } from '@/features/inventory/transfers';
import { apiErrorMessage } from '@/features/outlets/api';
import { toastSuccess, errorAlert } from '@/lib/swal';
import type { OutletOption } from '@/features/auth/api';
...
export function CreateTransferDialog({
  ...
  // Muat stok outlet asal — sumber daftar produk + batas qty.
  ...
  useEffect(() => {
    ...
    // Reset baris produk saat outlet asal berganti (stok berbeda).
  ...
  // Validasi sederhana untuk meng-enable tombol simpan.
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      errorAlert(apiErrorMessage(err, 'Gagal mengajukan transfer'));
    } finally {
      setSubmitting(false);
    }
  }
