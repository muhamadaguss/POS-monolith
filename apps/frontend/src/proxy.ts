...
export default auth((req) => {
  ...
  const isPublicRoute = path === '/' || path === '/login' || path === '/select-outlet' || path === '/register' || path === '/fitur' || path === '/harga' || path === '/faq' || path === '/privacy' || path === '/terms' || path === '/refund' || path === '/kontak' || path === '/payment-return';
